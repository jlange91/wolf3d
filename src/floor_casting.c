...
static inline void	ceil_casting(t_wolf *wolf, t_fc c, int x)
{
	...
	{
		c.floorTexX = (int)(c.currentFloorX * wolf->text[5].width) %
			wolf->text[5].width;
		c.floorTexY = (int)(c.currentFloorY * wolf->text[5].height) %
			wolf->text[5].height;
...
static inline void	floor_casting(t_wolf *wolf, t_fc c, int x)
{
	...
	{
		c.floorTexX = (int)(c.currentFloorX * wolf->text[4].width) %
			wolf->text[4].width;
		c.floorTexY = (int)(c.currentFloorY * wolf->text[4].height) %
			wolf->text[4].height;
